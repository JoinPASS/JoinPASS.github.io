+++
title = "Ground Rules"
description = "Initial ground rules covering meetings, internal sharing, external summaries, and participation expectations."
icon = "rule"
weight = 100
toc = true
+++
...
Whatever is presented and discussed is open for everyone in PASS to use freely, with two simple understandings:

- Do not attribute particular views to particular people. Share and build on what was discussed, but not "who said what," so everyone can think out loud without worrying about being quoted.
- Keep anything you cannot share out of your slides, including trade secrets, patent-sensitive work, or other restricted information. Raise it in the discussion instead if appropriate.
